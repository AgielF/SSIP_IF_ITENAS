<style>
    ...
    @media print {
        ...
        .btn, .nav-tabs, #search-input, #sort-filter,
        #items-per-page-filter,#pagination-controls,
        label, #record-info, .non-printable {
...
<div class="container my-5">
    ...
    <main class="fm-content card rounded-0 rounded-bottom border-top-0">
        <div class="card-body">
            ...
            <!-- FLASH MESSAGE: DITAMBAHKAN DI SINI (TIDAK MERUBAH BAGIAN LAIN) -->
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between 
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap non-printable">
                        ...
                        <div class="d-flex align-items-center">
                            <label class="me-2 small">Urutkan:</label>
                        ...
                        <div class="d-flex align-items-center">
                            <label class="me-2 small">Tampilkan:</label>
                        ...
                        <button id="add-data-btn" class="btn btn-sm btn-primary"
                            ...
                            <tr>
                                ...
                                <td class="non-printable">
                                    <button class="btn btn-sm btn-outline-secondary me-1 btn-edit"
                                            data-id="<?= $row[0] ?>"
                                            data-admin="<?= esc($row[1]) ?>"
                                            data-kategori="<?= esc($row[2]) ?>"
...
<div class="modal fade" id="addDataModal" tabindex="-1">
    <div class="modal-dialog">
        <form class="modal-content"
              action="<?= site_url('galeri_admin/store') ?>" method="post">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateTable() {
        ...
        rows.forEach(row => {
            row.style.display =
                row.innerText.toLowerCase().includes(searchTerm) ? "" : "none";
        });

        rows = rows.filter(r => r.style.display !== "none");

        const perPage = itemsPerPageFilter.value === "all"
            ? rows.length
            : parseInt(itemsPerPageFilter.value);
    ...
    searchInput.onkeyup = () => { currentPage = 1; updateTable(); };
    itemsPerPageFilter.onchange = () => { currentPage = 1; updateTable(); };
