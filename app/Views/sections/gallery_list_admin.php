...
<div class="container my-5">
    ...
    <ul class="nav nav-tabs" id="project-nav">
        <li class="nav-item">
            <a class="nav-link active" href="#" data-content="media_items">Daftar Galeri Umum</a>
        </li>
    </ul>
            ...
            <div id="printable-area">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
                    <div id="content-title-wrapper">
                        <h4 class="mb-0" id="content-title">Daftar Galeri Umum</h4>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const projectData = <?= json_encode(['media_items' => $media_items]) ?>;
    ...
    function updateView() {
        ...
        //urutkan data terbaru dan terlama sesuai Tanggal Upload
        const dateColumnIndex = data.headers.indexOf("Tanggal Upload"); // ✅ dinamis
