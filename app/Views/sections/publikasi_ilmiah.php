<?php
// Pastikan variabel publikasi ada
...
<div class="container my-5">
    ...
    <ul class="nav nav-tabs" id="publication-nav">
        <li class="nav-item"><a class="nav-link active" href="#" data-content="jurnal">Jurnal</a></li>
        <li class="nav-item"><a class="nav-link" href="#" data-content="prosiding">Prosiding</a></li>
        <li class="nav-item"><a class="nav-link" href="#" data-content="paten">Paten</a></li>
    </ul>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateView() {
        ...
        // cari kolom tanggal (bisa sesuaikan index)
